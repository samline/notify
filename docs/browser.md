...
```html
<script src="https://unpkg.com/@samline/notify@3.0.1/dist/browser/global.global.js"></script>
```

> Pin the version in production. Replace `3.0.1` with the version you ship.
...
- **Pin the version.** The CDN URL above is `3.0.1`. Replace it whenever you upgrade.
