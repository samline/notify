...
```html
<script src="https://unpkg.com/@samline/notify@0.2.2/dist/notify.umd.js"></script>
<link rel="stylesheet" href="https://unpkg.com/@samline/notify@0.2.2/dist/styles.css" />
...
| Browser / CDN | `<script src="https://unpkg.com/@samline/notify@0.2.2/dist/notify.umd.js"></script>`<br/>`const api = window.notify; api.initToasters(...);` | [docs/browser.md](docs/browser.md) |
