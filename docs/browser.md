...
```html
<script src="https://unpkg.com/@samline/notify@3.1.0/dist/browser/global.global.js"></script>
```
...
```html
<link rel="stylesheet" href="https://unpkg.com/@samline/notify@3.1.0/dist/styles.css" />
<script src="https://unpkg.com/@samline/notify@3.1.0/dist/browser/global.global.js" defer></script>
```
...
- **Pin the version.** The CDN URL above is `3.1.0`. Replace it whenever you upgrade.
